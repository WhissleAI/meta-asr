...
def process_jsonl(input_file, output_file):
    # Initialize the inverse normalizer
    inverse_normalizer = InverseNormalizer(lang='en')
    
    # Updated regex pattern to properly handle END tags
    ...
    def process_line(line):
        try:
            ...
            # Process all NER tags
            def replace_ner(match):
                tag_type = match.group(1)
                content = match.group(2).strip()
                
                # Handle CARDINAL numbers using NeMo
                ...
                # Capitalize content for other NER tags
        ...
        with open(input_file, 'r', encoding='utf-8') as infile, \
            ...
            for line_num, line in enumerate(infile, 1):
                try:
                    ...
                    outfile.write(line)  # Write original line in case of error
...
if __name__ == "__main__":
    ...
    output_file = "processed_manifest.jsonl"  # Output will be in current directory

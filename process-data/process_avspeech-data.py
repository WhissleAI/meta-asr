...
def convert_json_format(input_dir: str, output_dir: str):
    ...
    if all_results:
        output_path = os.path.join(output_dir, "avspeech-data_processed_4.json")
...
if __name__ == "__main__":
    input_dir = "split_json_files/part_5"
    output_dir = "output"
    
    print(f"Processing files from: {input_dir}")
    print(f"Saving output to: {output_dir}")
    
    convert_json_format(input_dir, output_dir)
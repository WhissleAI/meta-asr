...
def process_ner(text: str) -> Tuple[str, List[Dict[str, Any]]]:
    """
    Process text using Italian spaCy NER model
    """
    try:
...
def process_audio_files_with_transcriptions(base_dir: str, output_dir: str = "output", batch_size: int = 500) -> None:
...
if __name__ == "__main__":
    base_dir = "/external2/datasets/librespeech/mls_italian/test"
    output_dir = "/external2/datasets/json_jata/italian/test"

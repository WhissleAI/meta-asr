            ...
            <Card className="mb-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) => {
                                ...
                                // Reset model choice when transcription type changes
                                setModelChoice("gemini")
                                // Reset annotations if switching to simple
                                if (value === "simple") {
                ...
                <CardFooter>
                    <Button
                        ...
                        disabled={isLoading || !directoryPath || !outputPath}
                        className="w-full"
                    >
                        {isLoading ? (
                            <>
            ...
            {response && (
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {transcriptionType === "annotated" && Object.values(annotations).some((v) => v) && (
                            <div className="space-y-2">

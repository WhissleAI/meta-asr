...
if __name__ == "__main__":
    ...
    BASE_DATA_DIR = "/external4/datasets/madasr/chhatishgarhi/train"  # Directory containing 'audio_train' and 'text'
    FINAL_OUTPUT_JSONL = "/external4/datasets/madasr/chhatishgarhi/train/cg_annotated_output.jsonl" # Desired output file path

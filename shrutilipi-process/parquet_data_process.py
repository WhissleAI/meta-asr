...
def process_audio_files(base_dir: str, output_dir: str = "output", batch_size: int = 10) -> None:
    ...
    def save_batch(results, batch_num):
        if results:
            json_path = os.path.join(output_dir, f"audio_text_pairs_batch_{batch_num}.jsonl")
...
if __name__ == "__main__":
    base_dir = "/external4/datasets/Shrutilipi/hindi/hn"
    output_dir = "/external4/datasets/Shrutilipi/hindi/process_data"

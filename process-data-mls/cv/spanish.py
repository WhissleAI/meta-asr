...
language_code = "it"  # Change this to the language code you're processing (e.g., 'en', 'it', 'de')
base_dir = f"/external4/datasets/cv/cv-corpus-15.0-2023-09-08/{language_code}"
tsv_path = f"{base_dir}/validated.tsv"
clips_dir = f"{base_dir}/clips"
output_path = "/hydra2-prev/home/compute/workspace_himanshu/Processed_Data/gemini_metadata/europeen/cv/spanish_cv.jsonl" # Please change to it_cv.jsonl if you are processing Italian data

...
Example Output: "ENTITY_PERSON_NAME david END needs ENTITY_NUMBER 20 END ENTITY_FOOD_ITEM apples END SPEAKER_CHANGE AGE_45_60 GENDER_MALE EMOTION_HAP INTENT_REQUEST"
Input: "lucy booked a flight to paris on monday SPEAKER_CHANGE AGE_25_34 GENDER_FEMALE EMOTION_HAP"
Output: "ENTITY_PERSON_NAME lucy END booked a flight to ENTITY_LOCATION paris END on ENTITY_DATE monday END SPEAKER_CHANGE AGE_25_34 GENDER_FEMALE EMOTION_HAP INTENT_BOOKING"
Input: "sophia has a fever and headache SPEAKER_CHANGE AGE_13_17 GENDER_FEMALE EMOTION_SAD"
Output: "ENTITY_PERSON_NAME sophia END has a ENTITY_SYMPTOM fever END and ENTITY_SYMPTOM headache END SPEAKER_CHANGE AGE_13_17 GENDER_FEMALE EMOTION_SAD INTENT_HEALTH_CONCERN"
Input: "linda ordered a dell laptop SPEAKER_CHANGE AGE_18_24 GENDER_FEMALE EMOTION_NEU"
Output: "ENTITY_PERSON_NAME linda END ordered a ENTITY_BRAND dell END ENTITY_DEVICE laptop END SPEAKER_CHANGE AGE_18_24 GENDER_FEMALE EMOTION_NEU INTENT_PURCHASE"

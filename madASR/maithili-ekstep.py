...
if __name__ == "__main__":
    ...
    INPUT_DATA_DIR = "/external4/datasets/madasr/maithili-ekstep"  # Example: /path/to/your/maithili_data
    # >>> IMPORTANT: SET YOUR DESIRED OUTPUT FILE PATH <<<
    FINAL_OUTPUT_JSONL = "/external4/datasets/madasr/ekstep-jsonl/annotated_maithili_output2.jsonl" # Example: /path/to/your/maithili_data/annotated_output.jsonl
